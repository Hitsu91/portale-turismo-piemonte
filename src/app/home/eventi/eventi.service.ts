...
export class EventiService {
  private eventsScaffold: Evento[] = [
    ...
    {
      img: {
        src: 'assets/imgs/home/orta_san_giulio.jpg',
        alt: 'lago san giulio'
      },
    ...
    {
      img: {
        src: 'assets/imgs/home/manta_castello.jpg',
        alt: 'castello a manta'
      },
    ...
    {
      img: {
        src: 'assets/imgs/home/torino_reggia.jpg',
        alt: 'Reggia di Torino'
      },
  ...
  getEventi(elementPerRow: number): Evento[][] {
    return this.chunkArray(this.eventsScaffold, elementPerRow);
  }

  chunkArray(myArray: any[], chunkSize: number): Evento[][] {
    const results = [];
